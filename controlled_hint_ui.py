    ...
    with st.chat_message("assistant"):
        ...
        try:
            ...
            record_learning_interaction(
                ...
                private_progress_signal_request=controlled.get("private_progress_signal_request", 0),
                private_grade_signal_request=controlled.get("private_grade_signal_request", 0),
                private_signal_encoding_request=controlled.get("private_signal_encoding_request", 0),
                private_signal_output_detected=controlled.get("private_signal_output_detected", 0),
                private_signal_output_leaked=controlled.get("private_signal_output_leaked", 0),
                private_signal_output_category=controlled.get("private_signal_output_category", ""),
                private_signal_output_guarded=controlled.get("private_signal_output_guarded", 0),
            ...
            record_learning_interaction(
                ...
                private_progress_signal_request=0,
                private_grade_signal_request=0,
                private_signal_encoding_request=0,
                private_signal_output_detected=0,
                private_signal_output_leaked=0,
                private_signal_output_category="",
                private_signal_output_guarded=0,
