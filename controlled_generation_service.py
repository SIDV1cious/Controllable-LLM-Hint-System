...
DIRECT_ANSWER_REQUEST_PATTERN = re.compile(
    ...
    r"(?:reply|output|return|print|say)\s+exactly\s*:|"
    r"if.{0,36}(?:value|result|answer|option|choice|number|fraction).{0,48}"
    r"(?:reply|output|return|print|say).{0,24}(?:exactly|only)|"
